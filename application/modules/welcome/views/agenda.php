						...
						<div class="header-row">
							<div class="header-logo">
								<a href="demo-medical.html">
									<img src="assets/img/image/logo-dilan-1x.png" srcset="https://integra.web.id/eirtp-public/wp-content/uploads/2019/06/logo-dilan-1x.png 1x" width="176" height="71" alt="DILAN E-IRTP | Digitalisasi Layanan E-IRTP Logo" retina_logo_url="" class="fusion-sticky-logo">
								</a>
							</div>
						</div>
					</div>
									...
									<nav class="collapse">
										<ul class="nav nav-pills" id="mainNav">
											<li class="dropdown-full-color dropdown-secondary">
												<a class="nav-link active padding-header" href="#">
													BERANDA
												</a>
											</li>
											<li class="dropdown-full-color dropdown-secondary">
			...
			<div class="container">
				<div class="row">
					<div class="col-8">
						<div class="bg">
							<div class="text_color font-weight-bold">
								<h2 class="mb-0 text_color font-weight-bold mb-0">Penyuluhan Keamanan Pangan PIRT Bulan Juli 2019</h2>
								<span>tanggal waktu</span>
							</div>
						</div>
						<div class="mt-5">
							<p>Judul/Nama Agenda</p>
							<div class="mt-5">
					...
					<div class="col-4">
						...
						<div>
							<span class="font-weight-bold">Tanggal :</span> <p>tanggal</p>
							<hr class="border_bottom"/>
						</div>
						<div>
							<span class="font-weight-bold">Waktu :</span> <p>waktu</p>
							<hr class="border_bottom"/>
						</div>
						<div>
