...
<div id="container">
						...
						<div class="header-row">
							<div class="header-logo">
								<a href="demo-medical.html">
									<img src="assets/img/image/logo-dilan-1x.png">
								</a>
							</div>
						</div>
					</div>
									...
									<nav class="collapse">
										<ul class="nav nav-pills" id="mainNav">
											<li class="dropdown-full-color dropdown-secondary">
												<a class="nav-link active padding-header" href="#beranda">
													BERANDA
												</a>
											</li>
											<li class="dropdown-full-color dropdown-secondary">
												<a class="nav-link padding-header" href="#dilan_e_irtp">
													DILAN E-IRTP
												</a>
											</li>
											<li class="dropdown-full-color dropdown-secondary">
												<a class="nav-link padding-header" href="#petunjuk">
													Petunjuk
												</a>
											</li>
											<li class="dropdown-full-color dropdown-secondary">
												<a class="nav-link padding-header" href="#berita">
													BERITA
												</a>
											</li>
											<li class="dropdown-full-color dropdown-secondary">
												<a class="nav-link padding-header" href="#marketplace">
													MARKETPLACE
												</a>
											</li>
											<li class="dropdown-full-color dropdown-secondary">
												<a class="nav-link padding-header" href="#">
													POJOK DILAN
												</a>
											</li>
										</ul>
			...
			<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'gridwidth': 1170, 'gridheight': 650, 'disableProgressBar': 'on', 'navigation': {'bullets': {'enable': true, 'direction': 'vertical', 'h_align': 'right', 'v_align': 'center', 'space': 5}, 'arrows': {'enable': false}}}">
				<ul>
					<li data-transition="fade">
						<img src="assets/img/image/slide-1.jpg" 
							alt="test"
					...
					<li data-transition="fade">
						<img src="assets/img/image/slide-2.jpg" 
							alt=""
							data-bgposition="center center" 
							data-bgfit="cover" 
							data-bgrepeat="no-repeat"
			...
			<div class="row">
					...
					<a href="demo-medical-resources-detail.html" class="text-decoration-none">
						<span class="thumb-info thumb-info-side-image thumb-info-side-image-custom thumb-info-no-zoom thumb-info-no-zoom thumb-info-side-image-custom-highlight">
							<span class="thumb-info-side-image-wrapper">
								<img alt="gambar" class="img-fluid" src="assets/img/demos/medical/gallery/gallery-2.jpg">
							</span>
						</span>
					</a>
				</div>
				<div class="col-md-3">
					<a href="demo-medical-resources-detail.html" class="text-decoration-none">
						<span class="thumb-info thumb-info-side-image thumb-info-side-image-custom thumb-info-no-zoom thumb-info-no-zoom thumb-info-side-image-custom-highlight">
							<span class="thumb-info-side-image-wrapper">
								<img alt="gambar2" class="img-fluid" src="assets/img/demos/medical/gallery/gallery-3.jpg">
							</span>
						</span>
					</a>
				</div>
				<div class="col-md-3">
					<a href="demo-medical-resources-detail.html" class="text-decoration-none">
						<span class="thumb-info thumb-info-side-image thumb-info-side-image-custom thumb-info-no-zoom thumb-info-no-zoom thumb-info-side-image-custom-highlight">
							<span class="thumb-info-side-image-wrapper">
								<img alt="gambar3" class="img-fluid" src="assets/img/demos/medical/gallery/gallery-4.jpg">
							</span>
						</span>
					</a>
				</div>
				<div class="col-md-3">
					<a href="demo-medical-resources-detail.html" class="text-decoration-none">
						<span class="thumb-info thumb-info-side-image thumb-info-side-image-custom thumb-info-no-zoom thumb-info-no-zoom thumb-info-side-image-custom-highlight">
							<span class="thumb-info-side-image-wrapper">
								<img alt="gambar4" class="img-fluid" src="assets/img/demos/medical/gallery/gallery-4.jpg">
							</span>
						</span>
					</a>
				</div>
	...
	<section class="bg-petunjuk">
		<div class="container">
			...
			<div class="row">
				<div class="col-6 border border-white mb-5 d-flex justify-content-center">
				...
				<div class="col-6 border border-white mb-5 d-flex justify-content-center">
					<div class="row">
						<div class="col">
							<div>
								<h4 class="mt-3 mb-3 text-center">Jumlah Sertifikat P-IRT Diterbitkan Per Bulan</h4>
							</div>
						<div>
					</div>
					<div class="row">
				...
				<div class="col-4">
					<div>
						<a href="https://play.google.com/store/apps/details?id=id.go.jogjakota.jogjasmartservice" target="_blank" >
							<img src="assets/img/image/play_store.png" width="350" height="110" alt="Play Store">
						</a>
					</div>
				</div>
			</div>
